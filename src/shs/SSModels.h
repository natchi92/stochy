...
public:
	...
	ssmodels_t(std::optional<arma::mat> _A,
	...
	ssmodels_t(arma::mat _A, arma::mat _B, arma::mat _Q, arma::mat _F, arma::mat _Sigma);

	// initialise models from matfiles TODO(ncauchi) keep this feature? (matlab is being dropped)
...
private:
  ...
  std::optional<arma::mat>  F; // F for disturbances of in case of switching systems to correspond to the G function in Gw[k]
