...
int main(int argc, char **argv) {
    ...
    switch (selection) {
      case BAS_4D: {
        ...
        // Define safe set
        arma::mat Safe = {{18.5, 20.5}, {18.5, 20.5}, {18.5, 20.5}, {18.5, 20.5}};
      ...
      case BAS_7D: {
        ...
        arma::vec Bq0 = {{0.0195},
                         ...
                         { 0.0377},
                         { 0.0109}};
        arma::mat Gq0 = { {      0,         0   , 0.0000,         0   , 0.0019 ,        0,    0.0164},
                          ...
                          {     0  ,       0 ,        0   ,      0 ,        0    ,     0 ,   0.0109}};
        ssmodels_t model(Aq0,Bq0,Gq0);

        std::vector<ssmodels_t> models1 = {model};
        shs_t<arma::mat,int> cs1SHS(models1);

        // Define max error
        arma::mat grid = {{0.05,0.05,0.5, 0.5,0.5,0.5,0.5}};
